...
const products = [
  // MUSCLE BLAZE (7 products)
  {
    name: 'MuscleBlaze BCAA 6000',
    brand: 'MuscleBlaze',
    category: 'BCAA',
    ...
    price: 1499,
    originalPrice: 1999,
    imageUrl: '/uploads/supplements/muscleblaze-bcaa-6000.jpg',
    stock: 50,
    rating: 4.5,
    features: [
      '2:1:1 BCAA Ratio',
  ...
  },
  {
    ...
    description: 'High-calorie mass gainer with protein and complex carbs. Perfect for hard gainers looking to build muscle mass.',
    price: 2999,
    originalPrice: 3999,
    imageUrl: '/uploads/supplements/muscleblaze-super-gainer-xxl.jpg',
    stock: 35,
    rating: 4.6,
    features: [
      '1000+ Calories',
  ...
  {
    name: 'MuscleBlaze Pre-Workout Xtreme 200',
    brand: 'MuscleBlaze',
    category: 'Pre-Workout',
    description: 'Advanced pre-workout formula with caffeine and beta-alanine. Delivers explosive energy and intense focus for workouts.',
    price: 1799,
    originalPrice: 2399,
    imageUrl: '/images/products/PRE-WORKOUT XTREME 200.jpg',
    stock: 40,
    rating: 4.5,
    features: [
      'Explosive Energy',
  ...
  // MUSCLE-TECH (7 products)
  {
    name: 'MuscleTech Platinum Creatine Monohydrate',
    brand: 'MuscleTech',
    category: 'Creatine',
    description: 'Ultra-pure micronized creatine monohydrate. Scientifically proven to increase strength and muscle size.',
    price: 1199,
    originalPrice: 1599,
    imageUrl: '/images/products/Creatine Monohydrate.png',
    stock: 50,
    rating: 4.7,
    features: [
      'Micronized Formula',
  ...
  {
    name: 'MuscleTech Platinum Fish Oil',
    brand: 'MuscleTech',
    category: 'Omega-3',
    description: 'Premium fish oil with high EPA and DHA content. Supports cardiovascular health and joint function.',
    price: 999,
    originalPrice: 1399,
    imageUrl: '/images/products/Fish Oil.jpeg',
    stock: 55,
    rating: 4.5,
    features: [
      'High EPA & DHA',
  ...
  },
  {
    ...
    description: 'Pure beta-alanine powder to enhance muscular endurance. Delays fatigue during high-intensity training.',
    price: 1099,
    originalPrice: 1499,
    imageUrl: '/images/products/BETA ALANINE.jpg',
    stock: 45,
    rating: 4.5,
    features: [
      'Pure Beta-Alanine',
  ...
  {
    name: 'MyProtein Hard Gainer Extreme',
    brand: 'MyProtein',
    category: 'Mass Gainer',
    description: 'High-calorie mass gainer with 35g protein and 61g carbs per serving. Ideal for those struggling to gain weight.',
    price: 3299,
    originalPrice: 4299,
  ...
  {
    name: 'Nutrabay Bio Absorb Whey Protein',
    brand: 'Nutrabay',
    category: 'Protein',
    description: 'Advanced whey protein with bio-absorption technology for maximum protein utilization. Enhanced with digestive enzymes for better absorption and muscle recovery.',
    price: 2499,
    originalPrice: 3299,
    imageUrl: '/images/products/Bio Absorb Whey Protein.webp',
    stock: 55,
    rating: 4.7,
    features: [
      'Bio-Absorption Technology',
      '25g Protein per Serving',
  ...
  {
    name: 'Nutrabay Pro Whey Protein Isolate',
    brand: 'Nutrabay',
    category: 'Protein',
    description: 'Premium whey protein isolate with 90% protein content. Ultra-low fat and lactose for lean gains.',
    price: 2999,
    originalPrice: 3999,
    imageUrl: '/images/products/Whey Protein Isolate.jpeg',
    stock: 50,
    rating: 4.7,
    features: [
      '27g Protein',
  ...
  // OPTIMUM NUTRITION (7 products)
  {
    name: 'Optimum Nutrition Serious Mass Protein Powder',
    brand: 'Optimum Nutrition',
    category: 'Mass Gainer',
    description: 'High-calorie weight gainer with 50g protein and 1250 calories per serving. Perfect for serious mass gains.',
    price: 5499,
    originalPrice: 6999,
    imageUrl: '/images/products/Mass Protein Powder.jpg',
    stock: 25,
    rating: 4.8,
    features: [
      '50g Protein',
  ...
  },
  {
    ...
    brand: 'Optimum Nutrition',
    category: 'Creatine',
    description: 'Pure micronized creatine monohydrate. Supports muscle strength, power, and performance.',
    price: 1499,
    originalPrice: 1999,
    imageUrl: '/images/products/Micronized Creatine.jpeg',
    stock: 60,
    rating: 4.8,
    features: [
      'Micronized Formula',
...
async function seedProducts() {
  try {
    ...
    console.log('\n✅ Database seeded with 35 products (7 per brand)!');
    process.exit(0);
  } catch (error) {
